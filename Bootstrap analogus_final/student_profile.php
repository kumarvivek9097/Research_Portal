        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <img src="images/ducolorlogonew.png" alt="logo" height="75px" width="75px" padding="1px 1px 1px 1px" >
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li>
                        <a href="#" id="jake">User <i class="fa fa-user fa-lg" aria-hidden="true"></i></a>
                </li>
				<li>
					<a href="logout.php" id="jake">Logout  <i class="fa fa-sign-out" aria-hidden="true"></i></a>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="20781.jpg" class="img-circle img-responsive"> </div>
